 ...
 **************************************/
	...
	const size_t log_msgsz = strlen(err_msg) + 256;
	TEXT* const log_msg = (TEXT *) gds__alloc(static_cast<SLONG>(log_msgsz));
	// NOMEM: crash!
	log_msg[0] = '\0';
	...
	{
	case SIGSEGV:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Segmentation Fault.\n"
		...
		break;
	case SIGBUS:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Bus Error.\n"
	...
	case SIGILL:
		...
		fb_utils::snprintf(log_msg, log_msgsz, "%s Illegal Instruction.\n"
	...
	case SIGFPE:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Floating Point Error.\n"
		...
		break;
	default:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Unknown Exception.\n"
 ...
 **************************************/
	...
	case EXCEPTION_ACCESS_VIOLATION:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Access violation.\n"
	...
	case EXCEPTION_DATATYPE_MISALIGNMENT:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Datatype misalignment.\n"
	...
	case EXCEPTION_ARRAY_BOUNDS_EXCEEDED:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Array bounds exceeded.\n"
	...
	case EXCEPTION_FLT_DENORMAL_OPERAND:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Float denormal operand.\n"
	...
	case EXCEPTION_FLT_DIVIDE_BY_ZERO:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Floating-point divide by zero.\n"
	...
	case EXCEPTION_FLT_INEXACT_RESULT:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Floating-point inexact result.\n"
	...
	case EXCEPTION_FLT_INVALID_OPERATION:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Floating-point invalid operand.\n"
	...
	case EXCEPTION_FLT_OVERFLOW:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Floating-point overflow.\n"
	...
	case EXCEPTION_FLT_STACK_CHECK:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Floating-point stack check.\n"
	...
	case EXCEPTION_FLT_UNDERFLOW:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Floating-point underflow.\n"
				"\t\tThe exponent of a floating-point operation\n"
	...
	case EXCEPTION_INT_DIVIDE_BY_ZERO:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Integer divide by zero.\n"
	...
	case EXCEPTION_INT_OVERFLOW:
		fb_utils::snprintf(log_msg, log_msgsz, "%s Interger overflow.\n"
	...
	case 0xE06D7363: // E == Exception. 0x6D7363 == "msc". Intel and Borland use the same code to be compatible
		...
		break;
	default:
		fb_utils::snprintf(log_msg, log_msgsz, "%s An exception occurred that does\n"
 ...
 **************************************/
  ...
  retry:
	...
	fb_utils::snprintf(mapping_name, sizeof(mapping_name), "_mapping_%" ULONGFORMAT, 
		header_address[1]);
								...
								BOOL bInitialState, LPCSTR lpName)
{
	...
	if (lpName)
	{
		fb_utils::snprintf(sz, sizeof(sz), FAST_MUTEX_EVT_NAME, lpName);
		name = sz;
	}
	...
	if (lpMutex->hEvent)
	{
		...
		if (lpName)
			fb_utils::snprintf(sz, sizeof(sz), FAST_MUTEX_MAP_NAME, lpName);
