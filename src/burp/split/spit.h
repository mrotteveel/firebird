...
//inline constexpr int FILE_NM_ARR_LEN		= 20;
//inline constexpr char* GSPLIT_HDR_REC_NM	= "InterBase/Gsplit";
...
inline constexpr int M_BYTES			= (K_BYTES * K_BYTES);
inline constexpr int G_BYTES			= (K_BYTES * M_BYTES);
