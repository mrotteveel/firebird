...
Jrd::DmlNode* PAR_blr(Jrd::thread_db*, Jrd::Cached::Relation*, const UCHAR*, ULONG blr_length,
...
void PAR_preparsed_node(Jrd::thread_db*, Jrd::Cached::Relation*, Jrd::DmlNode*,
	Jrd::CompilerScratch*, Jrd::CompilerScratch**, Jrd::Statement**, const bool, USHORT);
Jrd::BoolExprNode* PAR_validation_blr(Jrd::thread_db*, Jrd::Cached::Relation*, const UCHAR* blr,
